...
class MavenResolverTest : ResolversTestBase() {
    ...
    fun testAuthFailure() {
        ...
        assertEquals(
            "ArtifactResolutionException: The following artifacts could not be resolved: " +
                    "com.jetbrains:fake-space-sdk:pom:1.0-dev (absent): " +
                    "Could not transfer artifact com.jetbrains:fake-space-sdk:pom:1.0-dev " +
