 ...
 *
 * @property callStack A sequence of PSI elements of the calls in the current execution stack, listed from the top to the bottom.
 */
@KaExperimentalApi
public class DebuggerExtension(public val callStack: Sequence<KtCallExpression?>)