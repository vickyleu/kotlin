 ...
 * ambiguous.
 *
 * The cache achieves this preciseness by employing a *fallback cache*. Consisting of two separate [FirCache]s, the cache first tries to
...
internal open class LLPsiAwareClassLikeSymbolCache<E : PsiElement, V : FirClassLikeSymbol<*>?, CONTEXT>(
     ...
     */
    fun getSymbolByClassId(classId: ClassId, context: CONTEXT): V = mainCache.getNotNullValueForNotNullContext(classId, context)
