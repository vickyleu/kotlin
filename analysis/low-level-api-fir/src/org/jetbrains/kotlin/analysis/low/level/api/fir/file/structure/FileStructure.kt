...
internal class FileStructure private constructor(
    ...
    fun invalidateElement(element: KtElement) {
        val container = getContainerForStructureElement(element, findNonLocalAutonomousContainer(element))
    ...
    fun getStructureElementFor(
        element: KtElement,
        nonLocalContainer: KtElement? = findNonLocalAutonomousContainer(element),
    ...
    private fun getContainerForStructureElement(element: KtElement, nonLocalContainer: KtElement?): KtElement {
        val autonomousContainer = nonLocalContainer?.takeIf { it.isAutonomousElement }
            ?: nonLocalContainer?.let { findNonLocalAutonomousContainer(it) }
     ...
     *
     * @see getContainerForStructureElement
     */
    private fun findNonLocalAutonomousContainer(element: KtElement): KtElement? {
