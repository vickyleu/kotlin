...
import org.jetbrains.kotlin.analysis.low.level.api.fir.providers.LLFirMainKotlinSymbolProvider
...
/**
 * [StubBasedFirDeserializedSymbolProvider] deserializes FIR symbols from existing stubs, retrieving them by [ClassId]/[CallableId] from a
...
) : LLFirMainKotlinSymbolProvider(session) {
