...
public class LLFirPreresolvedReversedDiagnosticCompilerFirTestDataTestGenerated extends AbstractLLFirPreresolvedReversedDiagnosticCompilerTestDataTest {
  ...
  public class Resolve {
    ...
    public class Inference {
      ...
      @Test
      @TestMetadata("lambdasReturnsShareCSFeatureEnabled.kt")
      public void testLambdasReturnsShareCSFeatureEnabled() {
        runTest("compiler/fir/analysis-tests/testData/resolve/inference/lambdasReturnsShareCSFeatureEnabled.kt");
      }
      ...
      @Test
      @TestMetadata("samConversionTopLevelFeatureEnabled.kt")
      public void testSamConversionTopLevelFeatureEnabled() {
        runTest("compiler/fir/analysis-tests/testData/resolve/inference/samConversionTopLevelFeatureEnabled.kt");
      }
