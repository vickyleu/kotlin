...
internal class KClassImpl<T : Any>(
    ...
    private val modality: Modality
        get() = kmClass?.modality ?: when {
            ...
            isSealedJavaClass?.invoke(jClass) == true -> Modality.SEALED
    ...
    companion object {
        // There's no `Class.isSealed` before JDK 17. Descriptor-based reflection had the same code in Java16SealedRecordLoader.
        private val isSealedJavaClass: Method? = try {
            Class::class.java.getDeclaredMethod("isSealed")
