...
val actualNativeArguments by compilerArgumentsLevel(Levels.nativeArguments) {
    compilerArgument {
...
The default value is 1.""".asReleaseDependent()
    ...
    compilerArgument {
        name = "Xsynthetic-accessors-with-narrowed-visibility"
        compilerName = "narrowedSyntheticAccessorsVisibility"
        description = "Narrow the visibility of generated synthetic accessors to _internal_ if such accessors are only used in inline functions that are not a part of public ABI".asReleaseDependent()
        valueType = BooleanType.defaultFalse
