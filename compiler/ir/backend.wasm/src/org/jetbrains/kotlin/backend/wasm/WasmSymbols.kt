...
class WasmSymbols(
    ...
    val addSuitRelatedBlock = maybeGetFunction("addSuitRelatedBlock", kotlinTestPackage)
    val executeSuitRelatedBlocks = maybeGetFunction("executeSuitRelatedBlocks", kotlinTestPackage)
