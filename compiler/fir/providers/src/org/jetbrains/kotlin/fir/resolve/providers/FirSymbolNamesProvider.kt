...
abstract class FirSymbolNamesProvider {
     ...
     *
     * [getPackageNames] is used as a fallback for [getPackageNamesWithTopLevelClassifiers] and [getPackageNamesWithTopLevelCallables] if
     * either returns `null`. It depends on the symbol names provider whether it's worth computing separate package sets for classifiers and
     * callables, or just one set containing all package names.
     */
