...
val levelToClassNameMap = listOf(
    ...
    ArgumentsInfo(
        levelName = Levels.commonKlibBasedArguments,
        className = "CommonKlibBasedCompilerArguments",
        levelIsFinal = false,
    ),
    ArgumentsInfo(
        levelName = Levels.wasmArguments,
        className = "K2WasmCompilerArguments",
        levelIsFinal = false,
    ),
    ArgumentsInfo(
        levelName = Levels.jsArguments,
        className = "K2JSCompilerArguments",
        levelIsFinal = true,
    ),
    ArgumentsInfo(
        levelName = Levels.nativeArguments,
        className = "K2NativeCompilerArguments",
        levelIsFinal = true,
    ),
    ArgumentsInfo(
        levelName = Levels.metadataArguments,
