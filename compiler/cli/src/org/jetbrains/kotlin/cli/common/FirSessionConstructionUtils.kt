...
private fun <F> prepareKlibSessions(
    ...
    return SessionConstructionUtils.prepareSessions(
        ...
        createLibrarySessionForHmppCommonModule = { sessionProvider, sharedLibrarySession, librariesList, libraryList ->
...
fun <F> prepareMetadataSessions(
    ...
    return SessionConstructionUtils.prepareSessions(
        ...
        createLibrarySessionForHmppCommonModule = { sessionProvider, sharedLibrarySession, commonModuleLibraryList, resolvedLibraries ->
            FirMetadataSessionFactory.createLibrarySession(
                sessionProvider,
                sharedLibrarySession,
...
object SessionConstructionUtils {
    fun <F> prepareSessions(
        ...
        createLibrarySessionForHmppCommonModule: (FirProjectSessionProvider, sharedLibrarySession: FirSession, DependencyListForCliModule, List<KotlinResolvedLibrary>) -> FirSession,
        ...
        val nonScriptSessions = when {
            ...
            languageVersionSettings.getFlag(AnalysisFlags.hierarchicalMultiplatformCompilation) -> createSessionsForHierarchicalMppProject(
                ...
                targetPlatform,
                sessionProvider,
                createLibrarySessionForHmppCommonModule,
                sessionConfigurator,
                fileBelongsToModule,
                createSourceSession
            )
    ...
    private fun <F> createSessionsForHierarchicalMppProject(
        ...
        for ((index, module) in hmppModuleStructure.modules.withIndex()) {
            ...
            val libraryList = if (isLeaf) {
                ...
                val libPaths = hmppModuleStructure.moduleDependencies[module].orEmpty()
                ...
                DependencyListForCliModule.build(moduleName) {
                    ...
                    createLibrarySessionForHmppCommonModule(sessionProvider, sharedLibrarySession, libraryList, resolvedLibraries)
                }
            }
